...
namespace Arena_Fighter_Hyunsoo_Ha
{
    class Arena
    {
        ...
        public static Character my_character = new Character(Program.select_name());
                ...
                { // if user makes a decision
                    ...
                    switch (menu_selected)
                    {
                        ...
                        case 3: // 4. Alchemy shop
                            my_alchemy.enter_alchemy();
                            break;
                        case 4: // 5. Armory
                            my_armory.enter_armory();
                            break;
                        case 5: // 6. Retire
                            if (wins == 0)
                            {
        ...
        {
            string text = "";
            text = File.ReadAllText(@"C:\Temp\manual.txt");
        ...
        public void retire()
        {
            ...
            if (wins == 1)
            {
                Console.WriteLine("{0} win | Beginner's luck? You survived the first fight but decided to leave this Arena. Some may say it was the best decision of yours.", wins);
            }
            else if (wins >= 2 && wins < 15)
            {
                Console.WriteLine("{0} | You retire as a modest gladiator. Surviving is what matters.", wins);
            }
            else if (wins >= 15 && wins < 35)
            {
                Console.WriteLine("{0} | You have made the Arena of Gory and Glory gorier and more glorious. Your retirement is celebrated by some.", wins);
            }
            else if (wins >= 35 && wins < 50)
            {
                Console.WriteLine("{0} | You are the best gladiator of your generation. Many people will remember your name.", wins);
            }
            else
            { // // 50 - 70
                Console.WriteLine("{0} | You are the greatest gladiator this Arena has ever seen." +
                    "\nYour name will remain in history and people will remember your name for hundreds of years.", wins);
            }
            Console.WriteLine("\n* * * * * * * * * * * * * * * * * * * * * * * *\n");
            view_log();
        }
        ...
        public static void death_retire()
        {
            ...
            {
                Console.WriteLine("{0} win | Beginner's luck? You survived the first fight but that was all for you. You die as a no-name gladiator.", wins);
            }
            else if (wins >= 2 && wins < 15)
            {
                Console.WriteLine("{0} wins | You die as a modest gladiator. Some may say that you were just about to bloom.", wins);
            }
            else if (wins >= 15 && wins < 35)
            {
                Console.WriteLine("{0} wins | You have made the Arena of Gory and Glory gorier and more glorious. Your grave is visited by some old fans.", wins);
            }
            else if (wins >= 35 && wins < 50)
            {
                Console.WriteLine("{0} wins | You proved yourself to be the best gladiator of your generation. Many people will remember your name." +
                    "It is a shame that you did not leave when you were ahead.", wins);
            }
            else
            { // 50 - 70
    ...
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("We hope you enjoyed our game, Arena of Gory and Glory!");
        ...
        public static string select_name()
        {
            ...
            while (true)
            {
                ...
                if (Character.enemy_names.Contains(input_name))
                {
